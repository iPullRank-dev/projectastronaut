        ...
        <div class="sidebar-inner">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="sideitemb">
              ...
              <a href="reportset.php"><i class="fa fa-file-text"></i><span>Report Setup</span> </a>


            </li>
              <li class="sideitemb">

              <a href="allcompany.php"><i class="fa fa-briefcase"></i><span>All Companies</span> </a>


            </li>
              <li class="sideitemb">

              <a href="newcompany.php"><i class="fa fa-plus"></i><span>New Company</span> </a>
