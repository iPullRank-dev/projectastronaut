...
<head>
    ...
    <title>Project Astronaut - 404</title>
    ...
    <body>
        <div style="max-width:600px;margin:0 auto;padding:20px;text-align:center;position:relative;top:50%;transform:translateY(-50%);">
            <img src="../resources/assets/images/logo/black.png" width="150px" height="50px">
