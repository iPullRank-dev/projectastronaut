        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-4" id="logbox">
                <div class="account-wall">
                    <p style="text-align:center;color:#fff;font-size:35px;font-weight:200;">ASTRONAUT<strong style="font-size:20px;">Beta</strong></p>
                    <br/>
                    <form class="form-signin" action="/admin/login" method="post" name="login_form" role="form">
                        ...
                        <input type="submit" value="Login" class="btn btn-lg btn-danger btn-block ladda-button">
